# Generated by Django 3.1.4 on 2020-12-11 10:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EmployeeNumber', models.CharField(blank=True, max_length=15, null=True, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.", regex='^\\+?1?\\d{9,15}$')])),
                ('MaritalStatus', models.CharField(choices=[('SINGLE', 'SINGLE'), ('MARRIED', 'MARRIED')], max_length=40)),
                ...
                ('BankBankAccountNo', models.CharField(max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='User',
