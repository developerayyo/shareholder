...
$(document).ready(function() {
  ...
  $(".row-grouping").DataTable({
    ...
    drawCallback : function(settings) {
      var api = this.api(), rows = api.rows({page : "current"}).nodes(),
          last = null;
      ...
      $(".footer-callback").DataTable({
        footerCallback : function(row, data, start, end, display) {
          var api = this.api(), intVal = function(i) {
            return "string" == typeof i ? 1 * i.replace(/[\$,]/g, "")
                                        : "number" == typeof i ? i : 0
          };
          total = api.column(4).data().reduce(
              function(a, b) { return intVal(a) + intVal(b) }, 0),
          pageTotal =
