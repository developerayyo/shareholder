!function(t, s, n) {
  var o = function(t, n) {
    "use strict";
    var o = function(s, n) {
      return this.CLASS && "ColVis" == this.CLASS ||
                 alert(
    ...
    return o.prototype = {
      ...
      rebuild : function() {
        ...
        this.dom.buttons.splice(0, this.dom.buttons.length),
            ...
            this._fnAddGroups(), this._fnAddButtons(), this._fnDrawCallback()
      },
           ...
           this.dom.button =
                t("<button />", {
                  class :
                    ...
                    .bind("mouseover" == this.s.activate ? "mouseover"
                                                         : "click",
                          function(
                              t) { t.preventDefault(), e._fnCollectionShow() })
                    .appendTo(this.dom.wrapper)[0],
           this.dom.catcher = this._fnDomCatcher(),
           this.dom.collection = this._fnDomCollection(),
           this.dom.background = this._fnDomBackground(), this._fnAddGroups(),
           this._fnAddButtons(), o = 0, i = this.s.dt.aoColumns.length;
            o < i; o++)
          this.s.abOriginal.push(this.s.dt.aoColumns[o].bVisible);
        this.s.dt.aoDrawCallback.push(
            {fn : function() { e._fnDrawCallback.call(e) }, sName : "ColVis"}),
      ...
      _fnApplyCustomisation : function(s) {
        t.extend(!0, this.s, o.defaults, s),
            !this.s.showAll && this.s.bShowAll &&
                (this.s.showAll = this.s.sShowAll),
            !this.s.restore && this.s.bRestore &&
                (this.s.restore = this.s.sRestore);
        var n = this.s.groups, i = this.s.aoGroups;
        if (n)
      ...
      _fnDrawCallback : function() {
        for (var s, n = this.s.dt.aoColumns, o = this.dom.buttons,
                    i = this.s.aoGroups, e = 0, l = o.length;
             e < l; e++)
          ...
          a(i[r].aiColumns)
              ...
              : u(i[r].aiColumns)
                    ? (t("input", this.dom.groupButtons[r]).prop("checked", !1),
                       t("input", this.dom.groupButtons[r])
      ...
      _fnAddGroups : function() {
        ...
        if (void 0 !== this.s.aoGroups)
          for (var s = 0, n = this.s.aoGroups.length; s < n; s++)
            t = this._fnDomGroupButton(s), this.dom.groupButtons.push(t),
            this.dom.buttons.push(t), this.dom.collection.appendChild(t)
      },
      _fnAddButtons : function() {
        var s, n = this.s.dt.aoColumns;
        ...
        "alpha" === this.s.order && this.dom.buttons.sort(function(t, s) {
          var o = n[t.__columnIdx].sTitle, i = n[s.__columnIdx].sTitle;
          return o === i ? 0 : o < i ? -1 : 1
        }),
            this.s.restore && ((s = this._fnDomRestoreButton()).className +=
                               " ColVis_Restore",
                               this.dom.buttons.push(s)),
            this.s.showAll &&
      ...
      _fnDomRestoreButton : function() {
        var s = this, n = this.s.dt;
        return t('<li class="ColVis_Special ' +
            ...
            .click(function(t) {
              ...
              s._fnAdjustOpenRows(), s.s.dt.oInstance.fnAdjustColumnSizing(!1),
                  s.s.dt.oInstance.fnDraw(!1)
            })[0]
      },
      _fnDomShowXButton : function(s, n) {
        var o = this, i = this.s.dt;
        return t('<li class="ColVis_Special ' +
                 (i.bJUI ? "ui-button ui-state-default" : "") + '">' + s +
                 "</li>")
            .click(function(t) {
              for (var s = 0, i = o.s.abOriginal.length; s < i; s++)
                -1 === o.s.aiExclude.indexOf(s) &&
                    o.s.dt.oInstance.fnSetColumnVis(s, n, !1);
              o._fnAdjustOpenRows(), o.s.dt.oInstance.fnAdjustColumnSizing(!1),
                  o.s.dt.oInstance.fnDraw(!1)
            })[0]
      },
      _fnDomGroupButton : function(s) {
        var n = this, o = this.s.dt, i = this.s.aoGroups[s];
        return t('<li class="ColVis_Special ' +
                 (o.bJUI ? "ui-button ui-state-default" : "") +
                 '"><label><input type="checkbox" /><span>' + i.sTitle +
                 "</span></label></li>")
            .click(function(s) {
      ...
      _fnDomColumnButton : function(s) {
        var n = this, o = this.s.dt.aoColumns[s], i = this.s.dt,
            e = null === this.s.fnLabel ? o.sTitle
                                        : this.s.fnLabel(s, o.sTitle, o.nTh);
        return t("<li " + (i.bJUI ? 'class="ui-button ui-state-default"' : "") +
                 '><label><input type="checkbox" /><span>' + e +
                 "</span></label></li>")
            .click(function(o) {
              ...
              "input" === o.target.nodeName.toLowerCase() &&
                  null !== n.s.fnStateChange && n.s.fnStateChange.call(n, s, e)
            })[0]
      },
      _fnDataTablesApiIndex : function() {
        for (var t = 0, s = this.s.dt.oInstance.length; t < s; t++)
          if (this.s.dt.oInstance[t] == this.s.dt.nTable)
            return t;
        return 0
      },
      ...
      _fnDomCatcher : function() {
        var n = this, o = s.createElement("div");
        return o.className = "ColVis_catcher",
               t(o).click(
                   function() { n._fnCollectionHide.call(n, null, null) }),
               o
      },
      _fnDomBackground : function() {
        var s = this,
            n = t("<div></div>")
                    ...
                    .css("opacity", 0)
                    .click(
                        function() { s._fnCollectionHide.call(s, null, null) });
      ...
      _fnCollectionShow : function() {
        var n, o = this, i = t(this.dom.button).offset(),
               e = this.dom.collection, l = this.dom.background,
               a = parseInt(i.left, 10),
               u = parseInt(i.top + t(this.dom.button).outerHeight(), 10);
        this.s.bCssPosition ||
            (e.style.top = u + "px", e.style.left = a + "px"),
            t(e).css({display : "block", opacity : 0}), l.style.bottom = "0px",
                                                        l.style.right = "0px";
        var r = this.dom.catcher.style;
        if (r.height = t(this.dom.button).outerHeight() + "px",
            r.width = t(this.dom.button).outerWidth() + "px",
            r.top = i.top + "px", r.left = a + "px", s.body.appendChild(l),
            s.body.appendChild(e), s.body.appendChild(this.dom.catcher),
            t(e).animate({opacity : 1}, o.s.iOverlayFade),
            t(l).animate({opacity : .1}, o.s.iOverlayFade, "linear",
                         function() {
                           t.browser && t.browser.msie &&
                               "6.0" == t.browser.version && o._fnDrawCallback()
                         }),
            !this.s.bCssPosition) {
          n = "left" == this.s.sAlign
                  ? a
                  : a - t(e).outerWidth() + t(this.dom.button).outerWidth(),
          e.style.left = n + "px";
          var d = t(e).outerWidth(), h = (t(e).outerHeight(), t(s).width());
      ...
      _fnCollectionHide : function() {
        var n = this;
        this.s.hidden || null === this.dom.collection ||
            (this.s.hidden = !0,
             t(this.dom.collection)
                 .animate({opacity : 0}, n.s.iOverlayFade,
                          function(t) { this.style.display = "none" }),
             t(this.dom.background)
                 .animate({opacity : 0}, n.s.iOverlayFade, function(t) {
                   s.body.removeChild(n.dom.background),
                       s.body.removeChild(n.dom.catcher)
                 }))
      },
      _fnAdjustOpenRows : function() {
        for (var t = this.s.dt.aoOpenRows,
                 s = this.s.dt.oApi._fnVisbleColumns(this.s.dt), n = 0,
                 o = t.length;
             n < o; n++)
          t[n].nTr.getElementsByTagName("td")[0].colSpan = s
           ...
           o.aInstances = [], o.prototype.CLASS = "ColVis", o.VERSION = "1.1.1",
           ...
           t.fn.dataTable.ColVis = o, t.fn.DataTable.ColVis = o, o
  };
  "function" == typeof define && define.amd
      ? define([ "jquery", "datatables" ], o)
      : "object" == typeof exports ? o(require("jquery"), require("datatables"))
                                   : jQuery && !jQuery.fn.dataTable.ColVis &&
