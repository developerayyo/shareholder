...
"function" === typeof define && define.amd
    ? define([ "jquery", "datatables.net" ],
             function(q) { return d(q, window, document) })
...
var s = d.fn.dataTable, u, m = function(a, b) {
  ...
  if (this instanceof m) {
    ...
    e._bInitComplete ? this._fnConstruct(b)
                     : e.oApi._fnCallbackReg(e, "aoInitComplete",
                                             function() { c._fnConstruct(b) },
                                             "FixedColumns")
  } else
    alert(
...
d.extend(m.prototype, {
  ...
  fnSetRowHeight : function(a, b) { a.style.height = b + "px" },
  fnGetPosition : function(a) {
    ...
    if (d(a).parents(".DTFC_Cloned").length) {
      ...
      return [
        b.fnGetPosition(d("tr", this.s.dt.nTBody)[a]), c,
  ...
  _fnConstruct : function(a) {
    ...
    if ("function" != typeof this.s.dt.oInstance.fnVersionCheck ||
      ...
      this.dom.grid.dt =
          d(this.s.dt.nTable).parents("div." + a.sScrollWrapper)[0];
      ...
      d(this.dom.scroller)
          ...
          .on("scroll.DTFC", function(a) {
            ...
            if ("main" === c &&
                (0 < b.s.iLeftColumns && (b.dom.grid.left.liner.scrollTop =
                                              b.dom.scroller.scrollTop),
                 0 < b.s.iRightColumns))
              b.dom.grid.right.liner.scrollTop = b.dom.scroller.scrollTop
          });
      var f = "onwheel" in r.createElement("div") ? "wheel.DTFC"
                                                  : "mousewheel.DTFC";
        ...
        d(b.dom.grid.left.liner)
            ...
            .on("scroll.DTFC",
                function(a) {
                  ...
                  "left" === c && (b.dom.scroller.scrollTop =
            ...
            .on(f, function(a) {
              b.dom.scroller.scrollLeft -=
                  "wheel" === a.type ? -a.originalEvent.deltaX
      ...
      h.on("draw.dt.DTFC",
          ...
          .on("select.dt.DTFC deselect.dt.DTFC",
              function(a) { "dt" === a.namespace && b._fnDraw(!1) })
  ...
  _fnGridSetup : function() {
    ...
    0 < this.s.iRightColumns &&
        (this.dom.grid.right.wrapper = f,
         ...
         f.style.right = a.bar + "px", b = d("div.DTFC_RightHeadBlocker", c)[0],
         b.style.width = a.bar + "px", b.style.right = -a.bar + "px",
         this.dom.grid.right.headBlock = b,
         b = d("div.DTFC_RightFootBlocker", c)[0], b.style.width = a.bar + "px",
         b.style.right = -a.bar + "px", this.dom.grid.right.footBlock = b,
         c.appendChild(f));
    if (this.s.dt.nTFoot &&
  ...
  _fnGridLayout : function() {
    ...
    var c = d(this.s.dt.nTable.parentNode).outerHeight(),
        ...
        i = "rtl" === d(this.dom.body).css("direction"), j = function(b, c) {
          f.bar ? a._firefoxScrollError()
                      ? 34 < d(b).height() && (b.style.width = c + f.bar + "px")
                      : b.style.width = c + f.bar + "px"
                : (b.style.width = c + 20 + "px", b.style.paddingRight = "20px",
                   b.style.boxSizing = "border-box")
        };
    f.x && (c -= f.bar);
    b.wrapper.style.height = e + "px";
    0 < this.s.iLeftColumns &&
        (e = b.left.wrapper, e.style.width = g + "px", e.style.height = "1px",
         i ? (e.style.left = "", e.style.right = 0)
           : (e.style.left = 0, e.style.right = ""),
         b.left.body.style.height = c + "px",
         b.left.foot && (b.left.foot.style.top = (f.x ? f.bar : 0) + "px"),
         j(b.left.liner, g), b.left.liner.style.height = c + "px");
    0 < this.s.iRightColumns &&
        (e = b.right.wrapper, e.style.width = h + "px", e.style.height = "1px",
         this.s.rtl
  ...
  _fnDraw : function(a) {
    ...
    null !== this.s.fnDrawCallback &&
        this.s.fnDrawCallback.call(this, this.dom.clone.left,
                                   this.dom.clone.right);
    d(this).trigger(
        "draw.dtfc",
        {leftClone : this.dom.clone.left, rightClone : this.dom.clone.right})
  },
  _fnCloneRight : function(a) {
    if (!(0 >= this.s.iRightColumns)) {
      var b, c = [];
      for (b = this.s.iTableColumns - this.s.iRightColumns;
           b < this.s.iTableColumns; b++)
    ...
    for (var e = [], f = [], g = [], h = 0, i = a.length; h < i; h++) {
      ...
      for (var l = 0, o = this.s.iTableColumns; l < o; l++)
        if (-1 !== d.inArray(l, b)) {
          ...
          -1 === p ? (p = d(a[h][l].cell).clone(c, !1)[0], f.push(p),
                      g.push(a[h][l].cell),
  ...
  _fnClone : function(a, b, c, e) {
      ...
      for (h = n.length; g < h; g++) {
        ...
        for (j = n[g].length; i < j; i++)
          ...
          d("span.DataTables_sort_icon", m[g][i].cell).each(function() {
            this.className =
                d("span.DataTables_sort_icon", n[g][i].cell)[0].className
          })
      }
    }
    ...
    if (0 < k.aiDisplay.length) {
      ...
      for (p = 0; p < c.length; p++)
        l = c[p], o = d(k.aoColumns[l].nTh).clone(!0)[0], o.innerHTML = "",
        j = o.style, j.paddingTop = "0", j.paddingBottom = "0",
        j.borderTopWidth = "0", j.borderBottomWidth = "0", j.height = 0,
        j.width = f.s.aiInnerWidths[l] + "px", h.appendChild(o);
      d(">tbody>tr", f.dom.body).each(function(a) {
        var a = f.s.dt.oFeatures.bServerSide === false
    ...
    k.oScroller !== t && (h = k.oScroller.dom.force,
                          b.forcer ? b.forcer.style.height = h.style.height
  ...
  _fnEqualiseHeights : function(a, b, c) {
    if (!("none" == this.s.sHeightMatch && "thead" !== a && "tfoot" !== a)) {
      ...
      a.outerHeight();
      a.height();
      for (var g = this._fnGetTrNodes(g), b = this._fnGetTrNodes(c), h = [],
               c = 0, a = b.length;
           c < a; c++)
        e = g[c].offsetHeight, f = b[c].offsetHeight, e = f > e ? f : e,
  ...
  _firefoxScrollError : function() {
    if (u === t) {
      var a = d("<div/>")
                  ...
                  .appendTo("body");
      u = a[0].clientWidth === a[0].offsetWidth &&
...
s.Api.register("fixedColumns().update()", function() {
  return this.iterator(
      "table", function(a) { a._oFixedColumns && a._oFixedColumns.fnUpdate() })
});
s.Api.register("fixedColumns().relayout()", function() {
  return this.iterator(
      "table",
      function(a) { a._oFixedColumns && a._oFixedColumns.fnRedrawLayout() })
});
