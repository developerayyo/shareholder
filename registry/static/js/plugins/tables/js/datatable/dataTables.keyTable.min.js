...
"function" === typeof define && define.amd
    ? define([ "jquery", "datatables.net" ],
             function(m) { return e(m, window, document) })
    : "object" === typeof exports ? module.exports = function(m, k) {
        m || (m = window);
        if (!k || !k.fn.dataTable)
          k = require("datatables.net")(m, k).$;
...
e.extend(n.prototype, {
  ...
  _constructor : function() {
    this._tabInput();
    var a = this, b = this.s.dt, c = e(b.table().node());
    ...
    if (this.c.editor)
      b.on("key.keyTable", function(b, c, d, e, j) { a._editor(d, j) });
    ...
    b.on("xhr.keyTable", function() {
      if (!a.s.focusDraw) {
        var c = a.s.lastFocus;
        c && (a.s.lastFocus = null, b.one("draw", function() { a._focus(c) }))
      }
    });
  ...
  _columns : function() {
    ...
    a.columns(":visible")
        .every(function(a) { -1 !== b.indexOf(a) && c.push(a) });
    return c
  },
  _editor : function(a, b) {
    var c = this.s.dt, d = this.c.editor;
    b.stopPropagation();
    ...
    c.one("key-blur.editor", function() { d.displayed() && d.submit() });
  ...
  _emitEvent : function(a, b) {
    this.s.dt.iterator("table",
                       function(c) { e(c.nTable).triggerHandler(a, b) })
  },
  _focus : function(a, b, c, d) {
    var i = this, g = this.s.dt, f = g.page.info(), h = this.s.lastFocus;
    d || (d = null);
    if (this.s.enable) {
      if ("number" !== typeof a) {
        var j = a.index(), b = j.column,
            a = g.rows({filter : "applied", order : "applied"})
                    .indexes()
                    .indexOf(j.row);
        f.serverSide && (a += f.start)
      }
      if (-1 !== f.length && (a < f.start || a >= f.start + f.length))
        this.s.focusDraw = !0, g.one("draw", function() {
                                  i.s.focusDraw = !1;
                                  i._focus(a, b)
      ...
      if (d) {
        ...
        if (!(this.c.keys && -1 === e.inArray(a.keyCode, this.c.keys)))
          ...
          case 34:
            if (c) {
              a.preventDefault();
              var f = g.cells({page : "current"}).nodes().indexOf(d.node());
              g.one("draw", function() {
                 var b = g.cells({page : "current"}).nodes();
                 i._focus(g.cell(f < b.length ? b[f] : b[b.length - 1]), null,
                          !0, a)
          ...
          case 35:
          case 36:
            c && (a.preventDefault(), b = g.cells({page : "current"}).indexes(),
                  this._focus(g.cell(b[35 === a.keyCode ? b.length - 1 : 0]),
                              null, !0, a));
            break;
          case 37:
  ...
  _scroll : function(a, b, c, d) {
    var d = c[d](), e = c.outerHeight(), c = c.outerWidth(), g = b.scrollTop(),
        f = b.scrollLeft(), h = a.height(), a = a.width();
  ...
  _shift : function(a, b, c) {
    var d = this.s.dt, i = d.page.info(), g = i.recordsDisplay,
        f = this.s.lastFocus, h = this._columns();
    if (f) {
      var j = d.rows({filter : "applied", order : "applied"})
                  .indexes()
                  .indexOf(f.index().row);
      ...
      i = h[d];
      "right" === b
          ? d >= h.length - 1 ? (j++, i = h[0]) : i = h[d + 1]
          : "left" === b ? 0 === d ? (j--, i = h[h.length - 1]) : i = h[d - 1]
                         : "up" === b ? j-- : "down" === b && j++;
      0 <= j && j < g && -1 !== e.inArray(i, h)
          ? (a.preventDefault(), this._focus(j, i, !0, a))
          : !c || !this.c.blurable ? a.preventDefault() : this._blur()
    }
  },
  _tabInput : function() {
    ...
    if (-1 != c)
      e('<div><input type="text" tabindex="' + c + '"/></div>')
          ...
          .children()
          .on("focus", function(c) {
            a._focus(b.cell(":eq(0)", "0:visible", {page : "current"}), null,
                     !0, c)
          })
  },
  _updateFixedColumns : function(a) {
    var b = this.s.dt, c = b.settings()[0];
    if (c._oFixedColumns) {
...
l.Api.register("cell().focus()", function() {
  return this.iterator(
      "cell", function(a, b, c) { a.keytable && a.keytable.focus(b, c) })
});
