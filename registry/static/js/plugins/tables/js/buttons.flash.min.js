...
"function" === typeof define && define.amd
    ? define([ "jquery", "datatables.net", "datatables.net-buttons" ],
             function(i) { return g(i, window, document) })
...
function l(a, b, d) {
  ...
  d && (d.attr && g(c).attr(d.attr),
        d.children && g.each(d.children, function(a, b) { c.appendChild(b) }),
...
function y(a, b) {
  ...
  for (var e = 0, f = a.body.length;
       e < f && !(c = a.body[e][b].toString().length, c > d && (d = c), 40 < d);
       e++)
    ;
  return 5 < d ? d : 5
}
function u(a) {
  n === o &&
      (n = -1 === v.serializeToString(g.parseXML(p["xl/worksheets/sheet1.xml"]))
                      .indexOf("xmlns:r"));
    ...
    a.addClass ||
        (a.hide = function() { this.style.display = "none" },
         ...
         a.removeClass =
             function(a) {
               this.className =
                   this.className.replace(RegExp("\\s*" + a + "\\s*"), " ")
                       .replace(/^\s+/, "")
                       .replace(/\s+$/, "")
             },
         a.hasClass = function(
             a) { return !!this.className.match(RegExp("\\s*" + a + "\\s*")) });
    return a
  },
  setMoviePath : function(a) { this.moviePath = a },
  dispatch : function(a, b,
                      d) { (a = this.clients[a]) && a.receiveEvent(b, d) },
...
h.Client.prototype = {
  ...
  glue : function(a, b) {
    ...
    this.domElement &&
        (this.domElement.appendChild(this.div),
         this.div.innerHTML =
             this.getHTML(c.width, c.height).replace(/&/g, "&amp;"))
  },
  positionElement : function() {
    ...
    0 !== a.width && 0 !== a.height &&
        (this.sized = !0, b = this.div.childNodes[0], b.width = a.width,
         b.height = a.height)
  },
  getHTML : function(a, b) {
    ...
    if (navigator.userAgent.match(/MSIE/))
      ...
      d +=
          '<embed id="' + this.movieId + '" src="' + h.moviePath +
          '" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="' +
          a + '" height="' + b + '" name="' + this.movieId +
  ...
  destroy : function() {
    ...
    this.domElement && this.div &&
        (g(this.div).remove(), this.div = this.domElement = null,
         g.each(h.clients, function(b, d) { d === a && delete h.clients[b] }))
  },
  ...
  setSheetData : function(
      a) { this.ready && this.movie.setSheetData(JSON.stringify(a)) },
  ...
  receiveEvent : function(a, b) {
    ...
    case "load":
      ...
      break;
    case "mouseover":
      this.domElement && this.cssEffects && this.recoverActive &&
          this.domElement.addClass("active");
      break;
    case "mouseout":
      this.domElement && this.cssEffects &&
          (this.recoverActive = !1, this.domElement.hasClass("active") &&
...
var w = function(a, b) {
  b.attr("id");
  b.parents("html").length ? a.glue(b[0], "")
                           : setTimeout(function() { w(a, b) }, 500)
}, q = function(a, b) {
  var d = "*" === a.filename && "*" !== a.title && a.title !== o ? a.title
                                                                 : a.filename;
  ...
  for (var d = b.newline ? b.newline
                         : navigator.userAgent.match(/Windows/) ? "\r\n" : "\n",
           c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary,
           f = b.fieldSeparator, g = RegExp(e, "g"),
           ...
           m = b.footer && c.footer ? d + i(c.footer) : "", l = [], t = 0,
           A = c.body.length;
       t < A; t++)
    l.push(i(c.body[t]));
...
j.ext.buttons.copyFlash = g.extend({}, s, {
  ...
  action : function(a, b, d, c) {
    c._fromFlash &&
        (a = c._flash, d = x(b, c),
         c = c.customize ? c.customize(d.str, c) : d.str, a.setAction("copy"),
         r(a, c),
...
j.ext.buttons.excelFlash = g.extend({}, s, {
  ...
  action : function(a, b, d, c) {
    var a = c._flash, e = 0, f = g.parseXML(p["xl/worksheets/sheet1.xml"]),
        ...
        b = b.buttons.exportData(c.exportOptions), i, k, j = function(a) {
          i = e + 1;
          k = l(f, "row", {attr : {r : i}});
          for (var b = 0, c = a.length; b < c; b++) {
            ...
            if (null === a[b] || a[b] === o)
              a[b] = "";
            "number" === typeof a[b] ||
                    a[b].match && g.trim(a[b]).match(/^-?\d+(\.\d+)?$/) &&
...
j.ext.buttons.pdfFlash = g.extend({}, s, {
  ...
  action : function(a, b, d, c) {
    var a = c._flash, d = b.buttons.exportData(c.exportOptions),
        e = b.table().node().offsetWidth,
        f = b.columns(c.columns).indexes().map(function(
            a) { return b.column(a).header().offsetWidth / e });
    a.setAction("pdf");
    a.setFileName(q(c));
    r(a, JSON.stringify({
      title : q(c, !1),
