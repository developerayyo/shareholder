...
"function" === typeof define && define.amd
    ? define([ "jquery", "datatables.net", "datatables.net-buttons" ],
             function(j) { return g(j, window, document) })
...
function E(a, b) {
  v === m &&
      (v = -1 === y.serializeToString(g.parseXML(F["xl/worksheets/sheet1.xml"]))
                      .indexOf("xmlns:r"));
    ...
    if (g.isPlainObject(c)) {
      ...
      if (v) {
        ...
        for (h = n.length; f < h; f++)
          ...
          k.value = n[f].value, e.setAttributeNode(k)
      }
...
r === m && (r = j.pdfMake);
var p;
var h = "undefined" !== typeof self && self || "undefined" !== typeof j && j ||
        this.content;
if ("undefined" !== typeof navigator &&
  ...
  var w = h.document.createElementNS("http://www.w3.org/1999/xhtml", "a"),
      ...
      P = function(
          a) { (h.setImmediate || h.setTimeout)(function() { throw a; }, 0) },
      A = 0, B = function(a) {
        setTimeout(function() {
          typeof a === "string" ? (h.URL || h.webkitURL || h).revokeObjectURL(a)
                                : a.remove()
        }, 4E4)
      }, C = function(a, b, d) {
            ...
            H(h.TEMPORARY, A, t(function(d) {
                d.root.getDirectory(
                    "saved", j, t(function(d) {
                      ...
                      d.getFile(
                          b, {create : false}, t(function(a) {
                            a.remove();
                            f()
                          }),
                          t(function(
                              a) { a.code === a.NOT_FOUND_ERR ? f() : k() }))
                    }),
                    k)
              }),
              k)
  ...
  "undefined" !== typeof navigator &&navigator.msSaveOrOpenBlob
      ...
      : (l.abort =
         ...
         l.readyState = l.INIT = 0, l.WRITING = 1, l.DONE = 2,
         l.error = l.onwritestart = l.onprogress = l.onwrite = l.onabort =
             l.onerror = l.onwriteend = null,
         p = function(a, b, d) { return new J(a, b, d) })
}
s.fileSave = p;
var x = function(a, b) {
  var d = a.filename === "*" && a.title !== "*" && a.title !== m ? a.title
                                                                 : a.filename;
  ...
  return a.newline ? a.newline
                   : navigator.userAgent.match(/Windows/) ? "\r\n" : "\n"
}, L = function(a, b) {
  for (var d = K(b), c = a.buttons.exportData(b.exportOptions),
           e = b.fieldBoundary, f = b.fieldSeparator, g = RegExp(e, "g"),
           ...
           i = b.footer && c.footer ? d + k(c.footer) : "", u = [], D = 0,
           l = c.body.length;
       D < l; D++)
    u.push(k(c.body[D]));
...
s.ext.buttons.copyHtml5 = {
  ...
  action : function(a, b, d, c) {
    ...
    g(i).on("keydown.buttons-copy", function(a) { a.keyCode === 27 && j() })
...
s.ext.buttons.csvHtml5 = {
  ...
  available : function() { return j.FileReader !== m && j.Blob },
...
s.ext.buttons.excelHtml5 = {
  ...
  action : function(a, b, d, c) {
          ...
          for (var b = 0, c = a.length; b < c; b++) {
            ...
            if (typeof a[b] === "number" ||
              ...
              d = o(f, "c", {
                ...
                children : {
                  row : o(f, "is", {children : {row : o(f, "t", {text : i})}})
                }
              })
            }
            k.appendChild(d)
    ...
    E(b, a);
    b.generateAsync ? b.generateAsync(d).then(function(a) { p(a, x(c)) })
                    : p(b.generate(d), x(c))
  },
  filename : "*",
  extension : ".xlsx",
...
s.ext.buttons.pdfHtml5 = {
  ...
  available : function() { return j.FileReader !== m && r },
  ...
  action : function(a, b, d, c) {
    ...
    c.message &&
        a.content.unshift(
            {text : c.message, style : "message", margin : [ 0, 0, 0, 12 ]});
    c.title &&
        a.content.unshift(
            {text : R(c, false), style : "title", margin : [ 0, 0, 0, 12 ]});
