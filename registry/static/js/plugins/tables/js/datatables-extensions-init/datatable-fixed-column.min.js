...
$(document).ready(function() {
  ...
  tableTndex
      .on("order.dt search.dt",
          function() {
            tableTndex.column(0, {search : "applied", order : "applied"})
                .nodes()
  ...
  $(".dataex-individual-filtering tfoot th").each(function(i) {
    var title =
        $(".dataex-individual-filtering thead th").eq($(this).index()).text();
  ...
  $(tableIndividualFiltering.table().container())
      .on("keyup", "tfoot input",
          function() {
            tableIndividualFiltering.column($(this).data("index"))
                .search(this.value)
                .draw()
          }),
