...
$(document).ready(function() {
  $(".sourced-data").DataTable(), $(".ajax-sourced").DataTable({
  ...
  var dataSet = [
    ...
    [
      "Michael Silva", "Marketing Designer", "London", "1581", "2012/11/27",
      "$198,500"
    ],
    [
    ...
    [
      "Jenette Caldwell", "Development Lead", "New York", "1937", "2011/09/03",
      "$345,000"
    ],
    [
    ...
    [
      "Jennifer Chang", "Regional Director", "Singapore", "9239", "2010/11/14",
      "$357,650"
    ],
    [
    ...
    [
      "Prescott Bartlett", "Technical Author", "London", "3606", "2011/05/07",
      "$145,000"
    ],
    [
    ...
    [
      "Martena Mccray", "Post-Sales support", "Edinburgh", "8240", "2011/03/09",
      "$324,050"
    ],
    [
  ...
  $(".javascript-sourced").DataTable({
    data : dataSet,
    columns : [
      {title : "Name"}, {title : "Position"}, {title : "Office"},
      {title : "Extn."}, {title : "Start date"}, {title : "Salary"}
    ]
  }),
